export default {
    ...
    mj: {
        ...
        , infoStar: '此项目基于开源项目 <a  class="text-blue-600 dark:text-blue-500" href="https://github.com/Dooy/chatgpt-web-midjourney-proxy" target="_blank"> chatgpt-web-midjourney-proxy </a>\
      魔改而来，如果你感觉不错，请分享给更多人使用，谢谢！'
        , setBtSaveChat: '仅保存会话'
        , setBtSaveSys: '保存至系统'
