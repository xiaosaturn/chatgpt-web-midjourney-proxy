export default {
    ...
    setting: {
        ...
        plzEmail: 'Пожалуйста, введите электронную почту',
        plzPassword: 'Пожалуйста, введите пароль',
        plzCaptcha: 'Пожалуйста, введите капчу',
        nowRegister: 'Зарегистрироваться сейчас',
        login: 'Войти',
        register: 'Регистрация',
        noAccount: 'Нет аккаунта? Идите на регистрацию!',
        noAccount2: 'Нет аккаунта?',
        haveAccount: 'У вас есть аккаунт?',
        nowLogin: 'Войти сейчас',
        back: 'Назад',
    ...
    "mj": {
        ...
        "cw": "0-100 Степень соответствия персонажа",
        "sref": "URL изображения Генерация изображений с одинаковым стилем",
        "cref": "URL изображения Генерация изображений с одинаковым персонажем",
    ...
    price: {
        ...
        freeUse: 'Бесплатное пробное использование',
        oneTime: 'Единоразово',
        monthly: 'Ежемесячная оплата',
        monthlyUse: 'Пробный период',
        month: 'месяц',
        yearly: 'Ежегодная оплата',
        yearlyUse: 'Самый выгодный',
        year: 'год',
        text1: 'Ежедневно дарим 10 сообщений, бесплатная пробная версия',
        text2: 'Доступны все модели ИИ (включая GPT-4o, GPT-4o-mini, GPT-3.5, Claude-3.5, Gemini-Pro, GLM, Moonshot и другие)',
        text3: '50 сообщений в день (свяжитесь со службой поддержки для бесплатного увеличения количества)',
        text4: '100 сообщений в день (свяжитесь со службой поддержки для бесплатного увеличения количества)',
        text5: 'Дарим 100 попыток рисования',
        text6: 'Дарим 1500 попыток рисования',
        text7: 'Подарок в виде 10 бесплатных попыток рисования',
        buy: 'Купить',
        contact: 'Если у вас есть вопросы, пожалуйста, свяжитесь со службой поддержки',
        telegram: 'Телеграм',
        wechat: 'ВиЧат',
        twitter: 'Твиттер',
        email: 'Электронная почта',
    ...
    userInfo: {
        ...
        chatCount: 'Осталось попыток разговора на сегодня',
        drawCount: 'Осталось попыток рисования на сегодня',

    },

    policy: {
        protocol: 'Пользовательское соглашение',
        privacy: 'Политика конфиденциальности',
        pay: 'Соглашение об оплате пользователя',
    }
