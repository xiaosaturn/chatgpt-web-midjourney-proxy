export default {
    ...
    setting: {
        ...
        plzCaptcha: '캡차를 입력하세요',
        nowRegister: '지금 등록하기',
        login: '로그인',
        register: '등록하기',
        noAccount: '계정이 없으신가요? 등록하러 가세요!',
        noAccount2: '계정이 없으신가요?',
    ...
    "mj": {
        ...
        "cw": "0-100 역할 참조 정도",
        "sref": "이미지 URL 생성 스타일이 일치하는 이미지",
        "cref": "이미지 URL 생성 캐릭터가 일치하는 이미지"
    ...
    price: {
        ...
        yearlyUse: '가장 경제적',
        year: '년',
        text1: '매일 10개의 메시지 무료 제공, 무료로 체험해보세요',
