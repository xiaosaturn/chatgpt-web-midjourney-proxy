export default {
    ...
    setting: {
        ...
        email: 'Email',
        captcha: 'Mã xác nhận',
        getCaptcha: 'Lấy mã xác nhận',
        password: 'Mật khẩu',
        rePassword: 'Nhập lại mật khẩu',
        plzEmail: 'Vui lòng nhập email',
        plzPassword: 'Vui lòng nhập mật khẩu',
        plzCaptcha: 'Vui lòng nhập mã xác nhận',
        nowRegister: 'Đăng ký ngay',
        login: 'Đăng nhập',
        register: 'Đăng ký',
        noAccount: 'Không có tài khoản? Đi đến đăng ký!',
        noAccount2: 'Không có tài khoản?',
        haveAccount: 'Có tài khoản?',
        nowLogin: 'Đăng nhập ngay',
        back: 'Quay lại',
