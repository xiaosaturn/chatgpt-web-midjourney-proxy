export default {
    ...
    setting: {
        ...
        plzEmail: 'Veuillez saisir l\'Email',
        plzPassword: 'Veuillez saisir le mot de passe',
        plzCaptcha: 'Veuillez saisir le Captcha',
        nowRegister: 'S’inscrire maintenant',
        login: 'Connexion',
        register: 'S’inscrire',
        noAccount: 'Pas de compte ? Allez vous inscrire !',
        noAccount2: 'Pas de compte ?',
        haveAccount: 'Avez-vous un compte ?',
        nowLogin: 'Se connecter maintenant',
        back: 'Retour',
