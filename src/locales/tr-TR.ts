export default {
    ...
    setting: {
        ...
        email: 'E-posta',
        captcha: 'Captcha',
        getCaptcha: 'Captcha al',
        password: 'Şifre',
        rePassword: 'Şifreyi tekrar girin',
        plzEmail: 'Lütfen e-posta girin',
        plzPassword: 'Lütfen şifre girin',
        plzCaptcha: 'Lütfen captcha girin',
        nowRegister: 'Şimdi kaydol',
        login: 'Giriş yap',
        register: 'Kayıt ol',
        noAccount: 'Hesabınız yok mu? Kayıt olmaya gidin!',
        noAccount2: 'Hesabınız yok mu?',
