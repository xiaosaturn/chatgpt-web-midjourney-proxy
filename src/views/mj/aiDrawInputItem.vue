...
<template>
    ...
    <div class="overflow-y-auto bg-[#fafbfc] px-4 dark:bg-[#18181c] h-full ">
        ...
        <section class="mb-4 flex justify-between items-center" v-for=" v in farr">
            <div>{{ v.v }}</div>
            <n-select v-model:value="f[v.k]" :options="drawlocalized[v.k + 'List']" size="small" class="!w-[60%]"
                :clearable="true" />
        </section>
        <!-- <template  >  </template> -->
        ...
        <div class="mb-1">
            <n-input type="textarea" v-model:value="st.text" :placeholder="$t('mjchat.prompt')" round clearable
                maxlength="2000" show-count :autosize="{ minRows: 2, maxRows: 5 }" />
        </div>
        <div class="mb-4 flex justify-between items-center">
            <div class="flex justify-start items-center flex-wrap">
                <div class="pt-1 pr-1 ">
                    <NPopover trigger="hover">
                        <template #trigger>
                            <n-tag type="error" round size="small" style="cursor: pointer; " :bordered="false"
                                @click="fsRef.click()" v-if="st.fileBase64.length">
                            ...
                            <n-tag type="warning" round size="small" style="cursor: pointer; " :bordered="false"
                                @click="fsRef.click()" v-else="st.fileBase64">
                                <div style="display: flex;">
                        ...
                        <div style="max-width: 240px;">
                            ...
                            3.<a class="text-green-500 cursor-pointer" @click="fsRef.click()"
                                v-html="$t('mjchat.imgCadd')"></a><br />
