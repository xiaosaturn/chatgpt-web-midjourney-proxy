...
const config = ref({
    model: ['o1-preview', 'o1-mini', 'o1-preview-2024-09-12', 'o1-mini-2024-09-12',
        'chatgpt-4o-latest', 'gpt-4o-2024-08-06', 'gpt-4o-mini', 'gpt-4o-2024-05-13', 'gpt-4o',
...
<template>
    ...
    <template v-if="st.openMore">
        ...
        <section class=" flex justify-between items-center ">
            ...
            <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
                <div class=" w-[200px]"><n-slider v-model:value="nGptStore.presence_penalty" :step="0.01" :max="1" />
                </div>
        ...
        <section class=" flex justify-between items-center ">
            ...
            <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
                <div class=" w-[200px]"><n-slider v-model:value="nGptStore.frequency_penalty" :step="0.01" :max="1" />
                </div>
