...
<template>
    <NModal v-model:show="show" style="width: 90%; max-width: 900px;border-radius: 20px;" preset="card">
        <div class="space-y-4">
            <NTabs type="segment">
                <NTabPane name="local" :tab="$t('store.local')">
                    ...
                    <NDataTable v-if="!isMobile" :max-height="400" :columns="columns" :data="dataSource"
                ...
                <NTabPane name="download" :tab="$t('store.online')">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <NButton strong secondary :disabled="downloadDisabled" :loading="importLoading"
                    ...
                    <div class="max-h-[360px] overflow-y-auto space-y-4">
                        <NCard v-for="info in promptRecommendList" :key="info.key" :title="info.key" :bordered="true"
                            embedded>
    ...
    <NModal v-model:show="showModal" style="width: 90%; max-width: 600px;" preset="card">
        <NSpace v-if="modalMode === 'add' || modalMode === 'modify'" vertical>
            ...
            <NButton block type="primary" :disabled="inputStatus"
                @click="() => { modalMode === 'add' ? addPromptTemplate() : modifyPromptTemplate() }">
                {{ t('common.confirm') }}
            </NButton>
        </NSpace>
        <NSpace v-if="modalMode === 'local_import'" vertical>
            <NInput v-model:value="tempPromptValue" :placeholder="t('store.importPlaceholder')"
